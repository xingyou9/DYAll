...
speedSettingsItem.detail = trimmedText;
    ...
    yttItem.type = 0;
    yttItem.svgIconImageName = @"ic_magic_outlined_20";
    yttItem.cellType = 26;
    ...
    systemSettingItem.svgIconImageName = @"ic_flash_outlined_20";
    ...
    // 行尾说明文字已按用户要求全部去掉：长 detail 会把标题挤压成单字（如「性能中心」只剩「性」）
    modeCenterItem.detail = @"";
